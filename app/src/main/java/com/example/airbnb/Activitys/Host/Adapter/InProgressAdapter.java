...
public class InProgressAdapter extends RecyclerView.Adapter<InProgressAdapter.viewHolder>{
    ...
    public InProgressAdapter(Context context, ArrayList<UnlistedModel> list) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        Picasso.get().load(model.getImage()).placeholder(R.drawable.photo).into(holder.binding.image);
